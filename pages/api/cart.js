...
//higher order component in react=recieves indivisual component and return new component,simply reusing the component logic
...
const addProduct = Authenticated(async (req, res) => {
  const { quantity, productId } = req.body; //taking from client side
